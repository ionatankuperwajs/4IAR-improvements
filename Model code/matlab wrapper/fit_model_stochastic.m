...
% 	settings.plb = [0.1,0.001,0,0.05,0.5,-5,-5,-5,-5,-5];
	...
	settings.ub = [8,1,1,1,10,10,10,10,10];
	settings.lb = [0.1,0.001,0.05,0.001,0,0,0,0,-10];
	settings.pub = [8,1,0.5,0.5,5,5,5,5,5];
	settings.plb = [0.1,0.001,0.05,0.002,0.1,0,0,0,-5];
	settings.c = 1;
    settings.N = 250000;
end
