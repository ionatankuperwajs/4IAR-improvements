...
if nargin < 2
	...
	settings.ub = [10,1,1,1,4,10,100,10,10,10,10];
	settings.lb = [0.1,0.001,0,0.05,0.25,-10,0.1,-10,-10,-10,-10];
	settings.pub = [10,1,0.5,0.5,2,5,50,5,5,5,5];
	settings.plb = [0.1,0.001,0,0.05,0.5,-5,1,-5,-5,-5,-5];
	settings.c = 1;
    settings.N = 10000;
end
