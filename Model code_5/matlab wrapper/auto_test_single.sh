...
direc=$SCRATCH/fourinarow/Model\ code_5/matlab\ wrapper/test/network_${SLURM_ARRAY_TASK_ID}.csv
params_path=$SCRATCH/fourinarow/Model\ code_5/matlab\ wrapper/fits/out_params.csv
codedirec=$SCRATCH/fourinarow/Model\ code_5/matlab\ wrapper
out_path=$SCRATCH/fourinarow/Model\ code_5/matlab\ wrapper/fits/out${SLURM_ARRAY_TASK_ID}
