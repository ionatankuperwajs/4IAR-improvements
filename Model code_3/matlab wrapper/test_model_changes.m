...
center_x = 1.0;
center_y = 1.0;
theta = [params(1:6) opening_weight cauchy center_x center_y params(7:end)];
times = 25;
Nevals = 2000;
...
c_act = theta(5);
gamma = theta(2);
pad_theta=[10000;  thresh; gamma; lambda; 1; 1; w_center; w_opening; cauchy; center_x; center_y; repmat(w,4,1); 0; c_act*repmat(w,4,1); 0; repmat(delta,17,1)];
