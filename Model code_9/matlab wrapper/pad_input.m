...
w_opening = [theta(7); theta(8); theta(9); theta(10)];  % corner opening weights
w = [theta(11); theta(12); theta(13); 10000];           % feature weights, 4-in-a-row fixed
w_pseudo3 = theta(14);      % 3-in-a-row feature weight with no space for 4, at the ends of the board
w_defensive = theta(15);    % weight for defending against immediate losses
